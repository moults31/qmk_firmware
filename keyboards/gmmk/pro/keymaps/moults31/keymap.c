...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, _______,           RGB_HUI, _______,          _______, _______, KC_CALC, _______, KC_INS,  _______, KC_PSCR, _______, _______, RESET,            _______,
        _______, RGB_MODE_REVERSE,  RGB_HUD, RGB_MODE_FORWARD, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN,          _______,          _______,
        _______,                    _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,          _______, RGB_SAI, _______,
        _______, _______,           _______,                                     _______,                            _______, _______, _______, RGB_VAD, RGB_SAD, RGB_VAI
    ),
